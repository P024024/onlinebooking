...
const Admin = () => {
  ...
  return (<html>
    <body>
      ...
      <div
        id="sidenav-2"
        class="h-screen w-60 -translate-x-full overflow-hidden bg-white shadow-[0_4px_12px_0_rgba(0,0,0,0.07),_0_2px_4px_rgba(0,0,0,0.05)] data-[te-sidenav-hidden='false']:translate-x-0 dark:bg-zinc-800"
      ...
      >
        ...
        <div class="p-5 !pl-[260px] text-center" id="content">
          ...
          <div class="my-5 flex text-start">
            ...
            cursus eget eros vitae, aliquam placerat velit. Vivamus luctus eros
            id sagittis luctus. Pellentesque felis nulla, rhoncus viverra nunc
            vitae, viverra aliquam ante. Ut feugiat mattis tempor.
          </div>
        </div>
      </div>
    </body>
